...
詳細は [Part 1-3: スキル自動選択メカニズム](03-how-skills-work.md#スキルの自動選択メカニズム) を参照。
...
詳細は [Part 1-3: スキルの自動選択メカニズム](03-how-skills-work.md) を参照。
...
→ 実装ガイド: [Part 4-6: 複数リポでの SKILL 共通化](06-multi-repo-skill-sharing.md)  
...
# Part 4-7: 運用手法（Runbook / Gate / Evidence / Scope / Rollout）
