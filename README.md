...
📖 **必ず最初にお読みください：**
→ [スキル形式の選択と実装](docs/00-fundamentals/skill-format-overview.md)
...
**[Part 0: スキル形式の選択と実装](docs/00-fundamentals/skill-format-overview.md)**
...
19. **[Part 4-6: 複数リポでの SKILL 共通化](docs/04-advanced/06-multi-repo-skill-sharing.md)** ⭐ 新規
    - 個人・チーム別の共通化パターン（Personal Skills / submodule / subtree / Config 駆動設計）
    - パターン選択フロー（個人利用 / チーム共有 / 更新管理の違い）
...
│   │   └── skill-format-overview.md ← まずここから始める
...
1. [Part 0: スキル形式の理解](docs/00-fundamentals/skill-format-overview.md) (15分)
   - SKILL.md の概要と実装例を確認
...
1. このREADMEを読む (5分)
2. [Part 0: スキル形式の理解](docs/00-fundamentals/skill-format-overview.md) (15分)
